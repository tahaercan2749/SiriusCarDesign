...
<head>
    ...
    @if(request()->routeIs('home'))
        @if($setting->seo_title!=NULL &&$setting->seo_description!=NULL)
            ...
            <meta name="twitter:title" content="{{$setting->seo_title}} | {{$setting->site_name}}"/>
    ...
    @elseif(request()->routeIs("404"))
        <title>Aradığınız Sayfa Bulunamadı | {{$setting->site_name}}</title>
        <meta name="description"
              content="Aradığınız sayfa web sitemizde mevcut değil. Linki kontrol edip tekrar deneyebilirsiniz"/>
        <meta name="author" content="{{env("APP_NAME")}}"/>
        <link rel="canonical" href="{{env("APP_URL")}}"/>

        <meta property="og:title" content="Aradığınız Sayfa Bulunamadı | {{$setting->site_name}}"/>
        ...
        <!-- Twitter Card Meta Etiketleri -->
        <meta name="twitter:card" content="summary_large_image"/>
        <meta name="twitter:title" content="Aradığınız Sayfa Bulunamadı | {{$setting->site_name}}"/>
    ...
    @else
        ...
        @if($seo!=NULL)
            ...
            <meta property="og:title" content="{{$seo->title}} | {{$setting->site_name}}"/>
            ...
            <meta name="twitter:card" content="summary_large_image"/>
            <meta name="twitter:title" content="{{$seo->title}} | {{$setting->site_name}}"/>
