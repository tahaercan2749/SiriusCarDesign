<footer>
        ...
        <div class="max-width first">
            ...
            <div class="right item">
                @if($iletisim!=NULL)
                    ...
                    <a @if($iletisim->page) href="{{$iletisim->page->slug}}" @endif class="spec-bg-stroke contact-title">
        ...
        <div class="max-width second">
            ...
            <div class="social-media">
                ...
                @if(isset($contactInfo->socialMedia)&&$contactInfo->socialMedia->facebook!=NULL)
                    <a href="{{$contactInfo->socialMedia->facebook}}" class="icon spec-bg-stroke">
                ...
                @if(isset($contactInfo->socialMedia)&&$contactInfo->socialMedia->youtube!=NULL)
                    <a href="{{$contactInfo->socialMedia->youtube}}" class="icon spec-bg-stroke">
                ...
                @if(isset($contactInfo->socialMedia)&&$contactInfo->socialMedia->whatsapp!=NULL)
                    <a href="{{$contactInfo->socialMedia->whatsapp}}" class="icon spec-bg-stroke">
    ...
    <div class="author">
        <div class=" max-width">
            <div class="reserved">
                Copyright © {{now()->year}} <b>{{$setting->site_name}}</b>. Tüm Hakları Saklıdır. <a href="kvkk"
                                                                                                     class="kvkk-link">KVKK</a>
            </div>
